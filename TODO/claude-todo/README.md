...
| 09 | Security hardening (admin/data endpoint exposure, auth rate limiting, persisted-state `eval`/CSP, Date.parse corruption) | 🟡 Final §§C–D reconciliation in PR #99; §B and §A's A1/A2 closed; §A's A3 token lifetime still unbounded | [09-security-hardening.md](./09-security-hardening.md) |
