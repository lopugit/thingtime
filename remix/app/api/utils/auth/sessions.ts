...
export type SessionDoc = {
  ...
  revokedAt: Date | null;
  type: 'tt.session';
  purpose?: 'browser' | 'service' | 'app' | 'app-sandbox' | 'pat' | 'device-pairing' | 'device' | 'oauth-code' | 'chatgpt-oauth-code' | 'chatgpt-mcp' | 'chatgpt-mcp-refresh' | 'chatgpt-mcp-connection';
