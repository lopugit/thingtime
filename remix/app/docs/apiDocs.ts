...
export const apiEndpointDocs: ApiEndpointDoc[] = [
  ...
  endpoint({
    ...
    detail:
      'Action Things accept runtime: browser with configurable http.request steps: literal method/path, query/body expressions, feature and minimumVersion, and an explicit capability endpoints allowlist. Browser programs use only http.request, actions.invoke, compute, fail and return; server programs cannot use browser requests. ' +
