...
export const apiEndpointDocs: ApiEndpointDoc[] = [
  ...
  endpoint({
    ...
    summary: 'Create an independent private copy of a readable page, component or action and its stored dependencies.',
    ...
    methods: ['POST'],
    steps: ['POST { id, key? }.', 'Open the returned id in Builder for a webpage or /thing/:id for a component/action.'],
