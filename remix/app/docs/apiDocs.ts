...
export const apiEndpointDocs: ApiEndpointDoc[] = [
	...
	endpoint({
		id: 'lopu-recordings', contractVersion: '1.4.0', featureVersion: '1.4.0', group: 'lopu', title: 'Watch recording automation',
	...
	endpoint({
		id: 'lopu-recordings-personal', contractVersion: '1.0.1', featureVersion: '1.0.1', group: 'lopu', title: 'Personal recording worker',
	...
	endpoint({
		id: 'lopu-recordings-run', contractVersion: '1.4.0', featureVersion: '1.4.0', group: 'lopu', title: 'Run recording automation',
  ...
  endpoint({
    id: 'things-fork',
    // 1.3.3: preserve linked gallery records without external fetches or content redirects.
    featureVersion: '1.3.3',
