...
export const apiEndpointDocs: ApiEndpointDoc[] = [
  ...
  endpoint({
    ...
    steps: [
      ...
      'Optionally add extended: any JSON up to 512KB, stored untouched and returned as-is — replace-on-write, null clears it, never searchable.',
