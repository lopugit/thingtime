...
export const builderGuideSections = [
	...
	},
	{
		...
		paragraphs: [
			...
			'Live Components expose read-only pending and pendingAction while a saved Action is awaiting confirmation or running. Bind labels and disabled states to them; tt-form accepts disabled to pause its fields without resetting its identity, revision or draft. These values belong to the current Component instance and cannot be overwritten by $ui.',
