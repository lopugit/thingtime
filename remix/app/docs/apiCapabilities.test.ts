...
test('subspace user flairs publish their contract versions', () => {
	...
	assert.equal(manifest.features['api.things'], '1.16.0');
...
test('background AI requires compatible operation and task contracts on both manifests', () => {
 ...
 for (const [feature, required] of Object.entries({ 'api.lopu-background-tasks': '1.0.0', 'api.lopu-chats-reply': '1.8.0', 'api.lopu-voice-reply': '1.4.0', 'api.lopu-musing': '1.1.0', 'api.ai-complete': '1.2.0' })) {
