...
test('shared dependency reads negotiate the additive Things contract on both manifests', () => {
	...
	// carried it on to 1.10.0 — the additive account-wide OAuth Things
	// permissions, which also realigned the contract version with the
	// feature version, so both manifests now publish the same number.
