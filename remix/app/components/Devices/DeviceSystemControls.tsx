...
export const DeviceSystemControls = memo(({ deviceId, displays, printers, cameras, bluetoothDevices, vpnServices, battery, powerTimers, appleMusic, spotify, controlFor, onAction }: DeviceSystemControlsProps) => (
	<Flex direction="column" gap={3}>
		...
		<Text color="var(--tt-muted, #71717a)" fontSize="10px">Idle timers use public IOKit and always require approval. HDR and Low Power Mode are reported read-only. Focus, AirDrop, Bluetooth radio state, camera privacy, and global media playback have no supported scoped user-agent setter; Apple Music and Spotify are deliberately limited consented media surfaces.</Text>
	</Flex>
));
