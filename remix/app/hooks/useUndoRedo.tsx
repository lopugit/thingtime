...
export const useUndoRedo = (args: { thingtimeReference: any; set: any; thingtimeRef: any }) => {
        ...
        try {
          ...
          if (redoEvent) {
            try {
              ...
              console.log('Most recently modified path:', lastModifiedPath);
              console.log('ThingtimeProvider redo cachedUndoHistoryPreviousParsed', cachedUndoHistoryPreviousParsed);
              console.log('ThingtimeProvider redo cachedUndoHistoryCurrrentParsed', cachedUndoHistoryCurrrentParsed);
              console.log('ThingtimeProvider redo cachedRedoHistoryPreviousParsed', cachedRedoHistoryPreviousParsed);
              console.log('ThingtimeProvider redo cachedRedoHistoryCurrrentParsed', cachedRedoHistoryCurrrentParsed);
              console.log(
                'ThingtimeProvider redo cachedRedoHistoryCurrrentParsed',
                lastModifiedPath,
              ...
              console.log('ThingtimeProvider redo cachedUndoHistoryPreviousParsed', cachedUndoHistoryPreviousParsed);
              console.log(
                'ThingtimeProvider redo cachedUndoHistoryCurrrentParsed',
                lastModifiedPath,
                smarts.getsmart(cachedUndoHistoryCurrrentParsed, lastModifiedPath)
              );
              console.log(
                'ThingtimeProvider redo cachedUndoHistoryPreviousParsed',
                lastModifiedPath,
              ...
              console.log('ThingtimeProvider redo lastRedoItem', lastRedoItem);
              // also specifically log the above path here:
              console.log('ThingtimeProvider redo lastRedoItem', lastModifiedPath, smarts.getsmart(lastRedoItem, lastModifiedPath));
          ...
          if (undoEvent) {
            try {
              ...
              console.log(
                'ThingtimeProvider undo cachedUndoHistoryPreviousParsed',
                lastModifiedPath,
                smarts.getsmart(cachedUndoHistoryPreviousParsed, lastModifiedPath)
              );
              console.log(
                'ThingtimeProvider undo cachedUndoHistoryCurrrentParsed',
                lastModifiedPath,
                smarts.getsmart(cachedUndoHistoryCurrrentParsed, lastModifiedPath)
              );
              ...
              // also specifically log the above path here:
              console.log('ThingtimeProvider undo lastRedoItem', lastModifiedPath, smarts.getsmart(lastRedoItem, lastModifiedPath));
  ...
  return {
    ...
    redo: () => {
      // @undoRedoEventKeyShortcutEventListener
      // if ctrl + shift + z, restore thingtime from localstorage history
    }
  };
};
