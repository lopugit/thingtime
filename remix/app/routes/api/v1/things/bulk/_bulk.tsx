...
// POST /api/v1/things/bulk — { op: 'move'|'copy'|'delete', ids: [...],
// folderId? } — multi-select operations for /things. Each id runs through the
// same single-item path as the dedicated endpoints (never a second code path),
// with a per-item ok/error result so one bad id doesn't fail the batch.
