...
// POST /api/v1/oauth/desktop/authorize — the consent endpoint the first-party
// /authorize page calls for installed public clients. It gives the browser only
// a short-lived, single-use code at an RFC 8252 loopback callback — never the
// app token. The loopback receiver must prove possession of the original S256
// verifier at /api/v1/oauth/token.
