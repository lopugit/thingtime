...
// GET /api/v1/apps/public?clientId=…&origin=… — anonymous lookup used by the
// authorize popup to render its consent screen. Returns the app's public face
// (clientId + name) ONLY when the app exists and the origin is on its
...
export const loader = async ({ request }: { request: Request }) => {
  ...
  return json({ ok: true, app: toEmbedApp(app), origin });
};
