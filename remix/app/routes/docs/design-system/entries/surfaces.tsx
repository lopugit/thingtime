...
export const surfacesEntries: DesignSystemEntry[] = [
	...
	},
	{
		...
		anatomy: [
			...
			'Placement — position top with a full-viewport flex container translateY(70px): centred by flow (immune to ancestor transforms), visually below the nav without breaking Chakra’s tight stacking, pointerEvents none so the wide container eats no clicks.',
