import { legalDocumentText, resolveLegalDocument } from '~/legal/documents';
...
export const thingtimeOverwriteAll = {
  terms: { hiddenContent1: stringLiteralToRichText(legalDocumentText(resolveLegalDocument('terms-of-service')!)) },
  privacy: { hiddenContent1: stringLiteralToRichText(legalDocumentText(resolveLegalDocument('privacy-policy')!)) },
  assets,
  branding: assets,
  cmdWatcher
};
