...
// the social-permalink and ChatGPT discovery routes share the /__server dest,
...
const serverFallbackIndex = routes.findIndex(
	(route, index) => route.dest === '/__server' && index !== chatGptDiscoveryIndex && !isPermalinkSrc(route.src)
);
