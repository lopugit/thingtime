...
const base: PublicPost = {
 ...
 text: 'Unlisted post with a nested comment gallery', images: [], attachments: [], mediaLayout: null, listing: null, thing: null,
 tags: [], reactionCounts: {}, viewerReactions: [], commentCount: 1, shareCount: 0, isShare: false, shareOf: null,
 createdAt: new Date().toISOString(), comments: [{id:'comment',thingtime:['post','comment'],author,type:'text',text:'Nested media inherits the unlisted audience',images:[],attachments:[
...
window.fetch = async () => new Response(JSON.stringify({ok:true,schemaVersion:1,origin:location.origin,features:{'api.things':{version:'1.22.0'},'api.attachment-content':{version:'1.9.0'}},thing:media,post:media}),{headers:{'Content-Type':'application/json'}});
