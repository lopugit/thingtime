...
// plain `tsc --noEmit` gate would fail every PR. This fails ONLY when the
// error count grows past scripts/typecheck-baseline.json, and nags (but
// passes) when it shrinks so the baseline gets ratcheted down.
//
