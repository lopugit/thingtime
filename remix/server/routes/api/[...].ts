...
const routeModules: Record<string, () => Promise<RouteModule>> = {
  ...
  'v1/crud/records': () => import('../../../app/routes/api/v1/crud/records/_records'),
  'v1/crud/records/delete': () => import('../../../app/routes/api/v1/crud/records/delete/_delete'),
  'v1/crud/records/permissions': () => import('../../../app/routes/api/v1/crud/records/permissions/_permissions'),
  'v1/crud/records/update': () => import('../../../app/routes/api/v1/crud/records/update/_update'),
  'v1/crud/search': () => import('../../../app/routes/api/v1/crud/search/_search'),
  'v1/crud/types': () => import('../../../app/routes/api/v1/crud/types/_types'),
  'v1/crud/types/delete': () => import('../../../app/routes/api/v1/crud/types/delete/_delete'),
