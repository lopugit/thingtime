...
- Installed UI and service lifecycle validation is in progress. Local candidate signing does not establish notarization; production notarization belongs to the protected release lane.
