...
flows should enqueue mail through the Thingtime email service boundary so SES,
other bridge providers, and the future owned MTA can share the same templates,
events, suppression list, and audit trail.
