...
| Prices can be presented without proving that money can move.                                                               | `remix/app/components/Settings/TierCard.tsx` renders tier price metadata, while the inspected package and route surface has no owned checkout or payment-provider contract.                                                                                                                                                                                                                         | High for this snapshot. Re-scan dependencies, routes, deployment configuration, and live behavior before repeating the claim.                          |
