...
| The planning corpus lacks a cross-product accessibility, internationalization, and adoption measurement gate. | A focused search of `TODO/`, `README.md`, `FUNDAMENTALS.md`, and `DECISIONS.md` found isolated accessibility requirements and privacy warnings, but no shared adoption metric dictionary or release-wide accessibility/i18n plan. | Medium. Re-run the focused search when new planning docs land. |
