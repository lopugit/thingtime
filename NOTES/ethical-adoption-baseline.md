...
| Powerful ACL-aware search does not yet form a legible, private, or accountable discovery contract.                                                                                    | The [search and discovery agency baseline](./search-and-discovery-agency-baseline.md) separates query, corpus, match, rank, recommendation, promotion, trust, and truth; inventories URL/cache and multi-rail boundaries; and proposes one private synthetic pilot.                                                                                                                   | High for the 2026-09-10 repository snapshot. Re-run after search routes, indexes, ranking, projections, caches, Commander, people/subspace/app discovery, or operational logging changes. |
| Owner-private recording and bounded transcription do not yet form a complete represented-person, lifecycle, correction, or deletion contract.                                         | The [recording agency and intimate-data stewardship baseline](./recording-agency-and-intimate-data-stewardship-baseline.md) separates capture, source audio, transcription, derivatives, action handoff, correction, deletion, and receipts; inventories current private controls; and proposes one single-person personal-device pilot.                                              | High for the 2026-09-11 repository snapshot. Re-run after recording sources, processors, providers, transcripts, derivatives, reminders, Lopu handoff, export, or deletion changes.       |
| Claim restraint across individual plans does not yet form a shared contract for Thingtime's own product speech.                                                                       | The [evidence agency and accountable product claims baseline](./evidence-agency-and-accountable-product-claims-baseline.md) separates intent, implementation, deployment, observed operation, user outcome, and durable assurance; inventories copy families; and proposes one exact-build synthetic export/restore claim pilot.                                                      | High for the 2026-09-14 planning snapshot. Re-run after relevant code, model, data, dependency, environment, policy, copy, visual, locale, evidence, incident, or ownership changes.      |
| A private composition fork can copy supported Things and media independently, but it does not yet form a complete reuse-permission, lineage, attribution, update, or remedy contract. | The [remix agency and responsible reuse baseline](./remix-agency-and-responsible-reuse-baseline.md) separates read, copy, fork, remix, source version, copy plan, lineage, attribution, independence, withdrawal, and dispute; inventories the current fork path; and proposes one two-account synthetic pilot.                                                                       | High for the 2026-09-11 repository snapshot. Re-run after fork/copy, sharing, attachment, provenance, terms, creator, export, moderation, or capability changes.                          |
| Follows, mutual friends, ACL audiences, message requests, memberships, and mutes do not yet form one predictable relationship lifecycle or stopping contract.                         | The [relationship agency and consentful connection baseline](./relationship-agency-and-consentful-connection-baseline.md) separates follow, request, friendship, circle, membership, mute, remove, block, and receipt; inventories cross-surface effects and gaps; and proposes one two-account synthetic pilot.                                                                      | High for the 2026-09-12 repository snapshot. Re-run after social, ACL, profile, Messenger, group, notification, search, moderation, cache, export, or relationship-policy changes.        |
...
9. **Notification evidence is semantically incomplete.** History records can
   ...
   lifecycle contract.
10. **Search meaning is fragmented.** Full search, Commander, quick switcher,
...
12. **Product claims have no shared evidence owner.** Plans constrain their own
    wording, API manifests state semantic compatibility, and delivery receipts
    bind observations to commits, but no registry maps Thingtime's own claims
    to meaning, scope, evidence, conditions, limitations, expiry, contradictions,
    every copy, correction, and remedy. The
    [product-claims baseline](./evidence-agency-and-accountable-product-claims-baseline.md)
    stages that responsibility without creating a generic trust badge.
