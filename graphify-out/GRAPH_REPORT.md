...
## Corpus Check
- 22 files · ~136,066 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 583 nodes · 1215 edges · 59 communities (31 shown, 28 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 13 edges (avg confidence: 0.59)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `41138b2d`
...
- [[_COMMUNITY_OpenAI Semantic Mode|OpenAI Semantic Mode]]
- [[_COMMUNITY_Partial Clone Object Hydration|Partial Clone Object Hydration]]
- [[_COMMUNITY_Promotion Recovery|Promotion Recovery]]
- [[_COMMUNITY_Rebase Stack Engine|Rebase Stack Engine]]
...
Cohesion: 0.14
Nodes (15): Graphify Semantic Extraction, Lopu PR Manager, ai-merge-paused Label, ANTHROPIC_API_KEY, claude-code-action, Conflict Resolution, Detector Handoff, Graphify Refresh (+7 more)
...
Cohesion: 0.09
Nodes (21): actions/checkout, actions/setup-node, Build All Branch Script, Lopu Agent Action, Lopu Internal All-branch Integration Workflow, Build-doctor Model Waterfall, pnpm/action-setup, Added (+13 more)
...
## Knowledge Gaps
- **165 isolated node(s):** `BASE_BRANCHES`, `MERGE_CONFIG`, `CAPACITY_PATTERNS`, `CREDENTIAL_PATTERNS`, `TRUSTED_ASSOCIATIONS` (+160 more)
