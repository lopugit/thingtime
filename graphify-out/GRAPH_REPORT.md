...
- `Control-plane changelog` --references--> `Rebase PRs and stacks (AI) workflow`  [INFERRED]
...
- `detect job (rebase)` --references--> `ai-merge-paused stop label`  [INFERRED]
...
- **AI PR automation control plane** — github_workflows_resolve_pr_conflicts, github_workflows_rebase_pr_stacks, github_workflows_ci_provider_router, remix_scripts_workflow_caller_contract, changelog_thin_listener_contract [INFERRED 0.80]
- **Detect → handoff → resolve → graphify refresh flow** — github_workflows_resolve_pr_conflicts_detect, github_workflows_resolve_pr_conflicts_handoff, github_workflows_resolve_pr_conflicts_resolve, github_workflows_resolve_pr_conflicts_graphify_refresh [EXTRACTED 0.85]
- **Commander release build and publish pipeline** — github_workflows_commander_release_release, commander_script_release_version, commander_script_build_and_run [EXTRACTED 0.90]
...
Cohesion: 0.11
Nodes (23): Control-plane changelog, ai-merge-paused stop label, no-ai-merge opt-out, Lane-aware promotion validator, Model-authored release analysis, Thin control-plane listener contract, Commander/script/build_and_run.sh, Commander/script/release-version.mjs (+15 more)
...
Cohesion: 0.20
Nodes (10): Build All Branch Script, Promote Features To Main Script, Promotion PR Changelog Script, Build All Branch Workflow, Route CI Compute Provider Workflow, Workflow Control-plane CI, Promote Develop To Main Workflow, Promote Features To Main Workflow (+2 more)
...
- `Commander App Release workflow` → `CI provider router workflow`  [AMBIGUOUS]
...
- **What is the exact relationship between `Commander App Release workflow` and `CI provider router workflow`?**
...
- **Why does `failureDetail()` connect `Community 4` to `Community 2`, `Community 5`, `Community 11`, `Community 17`, `Community 18`?**
