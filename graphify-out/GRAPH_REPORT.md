...
- **Control Plane PR Automation** — changelog_lopu_pr_management, changelog_ai_conflict_resolution, changelog_promotion_lanes, changelog_promotion_validator, changelog_graphify_refresh [EXTRACTED 0.90]
- **Promotion Lane System** — changelog_promotion_lanes, changelog_reverse_promotion_lane, changelog_release_analysis, changelog_promotion_rounds, changelog_promotion_validator [EXTRACTED 0.90]
...
Cohesion: 0.14
Nodes (17): AI Conflict Resolution, ai-merge-paused Label, Clean Behind PR Branch Update, Graphify Structural And Semantic Refresh, Lopu PR Management Workflow, Preview Wildcard Fallbacks, CI Promotion Lanes, Promotion Rounds (+9 more)
...
### Community 17 - "Lopu PR manager Workflow"
Cohesion: 0.24
Nodes (10): CodeQL Advanced Setup, Control Plane Changelog, github-actions Branch, Lopu CodeQL Triage, Product Branch Listeners, Signed Desktop PR Releases, pull_request Trigger, push Trigger For github-actions (+2 more)
...
## Knowledge Gaps
- **146 isolated node(s):** `BASE_BRANCHES`, `MERGE_CONFIG`, `TRUSTED_ASSOCIATIONS`, `TRUSTED_PERMISSIONS`, `PR_EVENT_ACTIONS` (+141 more)
...
- **Why does `selfTest()` connect `workflow-control-plane-contract.mjs` to `failureDetail`, `selfTest`, `promotion-worker-contract.sh`, `resolve-pr-conflicts-routing-contract.mjs`, `rebase-ownership-routing-contract.sh`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `runPromotion()` connect `promotion-worker-contract.sh` to `failureDetail`, `workflow-control-plane-contract.mjs`, `selfTest`, `resolve-pr-conflicts-routing-contract.mjs`, `rebase-ownership-routing-contract.sh`?**
