...
## Summary
- 1119 nodes · 2012 edges · 90 communities (73 shown, 17 thin omitted)
...
Cohesion: 0.15
Nodes (8): TestAPI(), Branding(), Logo(), Editor(), TopSpacing(), checkerMatrix, action(), earlyReturn()
...
Cohesion: 0.15
Nodes (13): Submit(), useAsyncFetcher(), Raw(), RawResult(), RawResultProps, RawResults(), Index(), ThingtimeURL() (+5 more)
...
## Knowledge Gaps
- **434 isolated node(s):** `extends`, `name`, `version`, `description`, `main` (+429 more)
...
- **Why does `Thingtime()` connect `Community 76` to `API Package Manifest`, `Community 72`, `Community 73`, `Community 45`, `Smarts Opt Helpers`, `Community 87`?**
