...
Cohesion: 0.22
Nodes (10): actions/checkout, actions/setup-node, Build All Branch Script, Lopu Agent Action, Lopu Internal All-branch Integration Workflow, Build-doctor Model Waterfall, pnpm/action-setup, Develop PR Preview Deployment Script (+2 more)
...
Cohesion: 0.67
Nodes (3): github-actions CI Control Plane, Thin Product Branch Listeners, Vercel Git Deployment Kill Switch

## Knowledge Gaps
- **151 isolated node(s):** `BASE_BRANCHES`, `MERGE_CONFIG`, `CAPACITY_PATTERNS`, `CREDENTIAL_PATTERNS`, `TRUSTED_ASSOCIATIONS` (+146 more)
