...
## Corpus Check
- 226 files · ~554,201 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1116 nodes · 2009 edges · 88 communities (71 shown, 17 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e5c124c5`
...
6. `getCurrentUser()` - 16 edges
7. `compilerOptions` - 16 edges
8. `compilerOptions` - 16 edges
9. `openNewFinderWindow()` - 15 edges
...
Cohesion: 0.07
Nodes (36): TestAPI(), getUsers(), SeedUser, Editor(), actionExport(), earlyReturn(), getConnectionAction, TopSpacing() (+28 more)
...
Cohesion: 0.08
Nodes (20): Session, App(), loader(), logConfig, whitelist, whitelistObj, ChakraWrapper(), chakras (+12 more)
...
Cohesion: 0.14
Nodes (21): DevKit(), getQueryParams(), useApi(), CurrentUser, useCurrentUser(), Login(), inputSx, Register() (+13 more)
...
Cohesion: 0.18
Nodes (14): commanderArgs, CommanderV1(), sanitise(), useThings(), MagicInput, MagicInputProps, getParentPath(), uuid (+6 more)

### Community 72 - "Community 72"
Cohesion: 0.13
Nodes (14): Submit(), useAsyncFetcher(), Raw(), RawResult(), RawResultProps, RawResults(), Index(), SettingsMenu() (+6 more)

### Community 73 - "Community 73"
Cohesion: 0.28
Nodes (8): CommanderV2(), usePath(), Icon(), Main(), Footer(), Nav(), ProfileDrawer(), RainbowSkeleton()
...
Cohesion: 0.08
Nodes (48): authCookie, clearAuthCookie(), getAuthToken(), serializeAuthCookie(), SendArgs, sendEmail(), sendVerificationEmail(), consumeEmailVerification() (+40 more)
...
Cohesion: 0.07
Nodes (28): assets, Branding(), Logo(), value, newTimeline(), PathArray, ThingtimeLine(), Timeline (+20 more)
...
## Knowledge Gaps
- **432 isolated node(s):** `extends`, `name`, `version`, `description`, `main` (+427 more)
...
- **Why does `useThingtime()` connect `Community 72` to `Community 73`, `Community 76`, `Community 45`, `Smarts Opt Helpers`, `Community 87`?**
