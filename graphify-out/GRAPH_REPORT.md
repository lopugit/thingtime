...
- **Why does `selfTest()` connect `selfTest` to `verify-promotion-source-authority.sh`, `promote-features-to-main.mjs`, `runPromotion`, `failureDetail`?**
...
- **Why does `failureDetail()` connect `failureDetail` to `verify-promotion-source-authority.sh`, `selfTest`, `promote-features-to-main.mjs`, `runPromotion`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
