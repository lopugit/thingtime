...
- **Commander release build-and-publish pipeline** — github_workflows_commander_release_release_metadata, github_workflows_commander_release_existing_release, commander_script_build_and_run, github_workflows_commander_release_collect_assets, github_workflows_commander_release_publish [EXTRACTED 0.90]
...
- **Untrusted-AI containment controls (verify, secret scan, lockfile regen, graphify reset)** — github_workflows_resolve_pr_conflicts_verify, github_workflows_resolve_pr_conflicts_secret_scan, github_workflows_resolve_pr_conflicts_lockfile_regen, github_workflows_resolve_pr_conflicts_graphify_refresh [INFERRED 0.80]
...
Cohesion: 0.08
Nodes (30): actions/checkout@v4, actions/setup-node@v4, Commander/script/build_and_run.sh, Commander/script/release-version.mjs, dtolnay/rust-toolchain@stable, Commander App Release Workflow, Collect release assets step, Stop if this release already exists step (+22 more)
...
## Knowledge Gaps
- **124 isolated node(s):** `BASE_BRANCHES`, `MERGE_CONFIG`, `CFG`, `EXEC_OPTS`, `STRIP_PREFIXES` (+119 more)
...
- **Why does `selfTest()` connect `Community 2` to `Community 17`, `Community 11`, `Community 4`, `Community 6`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `runPromotion()` connect `Community 11` to `Community 2`, `Community 4`, `Community 6`, `Community 17`, `Community 18`?**
