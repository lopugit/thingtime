...
- `Resolve Rebase Conflict Set with Lopu in Scratch` --calls--> `Lopu Agent Composite Action`  [EXTRACTED]
...
- **CI Control Plane Components** — readme_github_actions_branch, readme_workflows_directory, readme_scripts_directory, readme_actions_directory, readme_vercel_json [EXTRACTED 1.00]
...
- **Canonical AI Instruction Symlink Set** — readme_ai_all, readme_agents_symlink, readme_claude_symlink [EXTRACTED 0.95]
...
Cohesion: 0.09
Nodes (23): Analyze Matrix Job, base64 Decode, actions/checkout, github/codeql-action/analyze, github/codeql-action/init, gh api, grep Listener Check, jq (+15 more)
