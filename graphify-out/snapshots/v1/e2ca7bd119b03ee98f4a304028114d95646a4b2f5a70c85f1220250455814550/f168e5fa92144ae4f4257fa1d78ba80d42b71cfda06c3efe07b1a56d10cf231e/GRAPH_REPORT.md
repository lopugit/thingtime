...
## Summary
- 919 nodes · 1937 edges · 100 communities (46 shown, 54 thin omitted)
...
- [[_COMMUNITY_Admin Preview Publishing|Admin Preview Publishing]]
- [[_COMMUNITY_Graph Snapshot Management|Graph Snapshot Management]]
- [[_COMMUNITY_Promotion Changelog Generation|Promotion Changelog Generation]]
- [[_COMMUNITY_All-Branch Build Validation|All-Branch Build Validation]]
- [[_COMMUNITY_Prebuilt Archive Extraction|Prebuilt Archive Extraction]]
- [[_COMMUNITY_Promotion Pick Planning|Promotion Pick Planning]]
...
- [[_COMMUNITY_Pull Request Status|Pull Request Status]]
- [[_COMMUNITY_Promotion Reservation Workflow|Promotion Reservation Workflow]]
- [[_COMMUNITY_Promotion Pull Request Management|Promotion Pull Request Management]]
- [[_COMMUNITY_CodeQL PR Backfill|CodeQL PR Backfill]]
- [[_COMMUNITY_Feature Promotion Recovery|Feature Promotion Recovery]]
- [[_COMMUNITY_Agent Credential Handling|Agent Credential Handling]]
- [[_COMMUNITY_Main Develop Sync Merge|Main Develop Sync Merge]]
- [[_COMMUNITY_Promotion Worker Contract|Promotion Worker Contract]]
- [[_COMMUNITY_Rebase Edit Testing|Rebase Edit Testing]]
...
- [[_COMMUNITY_Release Pipeline Workflows|Release Pipeline Workflows]]
...
- [[_COMMUNITY_Control Plane Events|Control Plane Events]]
- [[_COMMUNITY_Promotion Dispatch Queue|Promotion Dispatch Queue]]
- [[_COMMUNITY_Review Queue Management|Review Queue Management]]
- [[_COMMUNITY_Feature Stack Planning|Feature Stack Planning]]
- [[_COMMUNITY_Credential Vault Access|Credential Vault Access]]
- [[_COMMUNITY_Rebase Start Script|Rebase Start Script]]
- [[_COMMUNITY_API CI Workflow|API CI Workflow]]
- [[_COMMUNITY_Promotion Source Verification|Promotion Source Verification]]
- [[_COMMUNITY_Preview Reliability Repair|Preview Reliability Repair]]
- [[_COMMUNITY_Electron Release Gates|Electron Release Gates]]
- [[_COMMUNITY_Sync PR Auto-Merge|Sync PR Auto-Merge]]
...
- [[_COMMUNITY_Credential Vault Migration|Credential Vault Migration]]
- [[_COMMUNITY_Progress Heartbeat Controller|Progress Heartbeat Controller]]
- [[_COMMUNITY_Control Plane Documentation|Control Plane Documentation]]
...
- [[_COMMUNITY_Instruction Resolution Tests|Instruction Resolution Tests]]
- [[_COMMUNITY_Rebase Engine Workflow|Rebase Engine Workflow]]
- [[_COMMUNITY_Commander App Release|Commander App Release]]
...
- [[_COMMUNITY_Contract Advisory Jobs|Contract Advisory Jobs]]
- [[_COMMUNITY_Internal Promotion Workflows|Internal Promotion Workflows]]
- [[_COMMUNITY_Graphify CLI|Graphify CLI]]
- [[_COMMUNITY_Canonical AI Instructions|Canonical AI Instructions]]
- [[_COMMUNITY_API Registration Convention|API Registration Convention]]
...
- [[_COMMUNITY_PM2 Development Stack|PM2 Development Stack]]
- [[_COMMUNITY_Global Instruction Symlinks|Global Instruction Symlinks]]
- [[_COMMUNITY_Worktree Port Resolution|Worktree Port Resolution]]
- [[_COMMUNITY_Fundamentals Guide|Fundamentals Guide]]
- [[_COMMUNITY_Lopu Agent Action|Lopu Agent Action]]
- [[_COMMUNITY_Graph Snapshot Router|Graph Snapshot Router]]
- [[_COMMUNITY_CodeQL PR Handoff|CodeQL PR Handoff]]
- [[_COMMUNITY_Legacy Conflict Resolver|Legacy Conflict Resolver]]
- [[_COMMUNITY_Clean Sync Lane|Clean Sync Lane]]
- [[_COMMUNITY_Develop Branch|Develop Branch]]
- [[_COMMUNITY_Exact-Head REST Merge|Exact-Head REST Merge]]
- [[_COMMUNITY_GitHub Auto-Merge|GitHub Auto-Merge]]
- [[_COMMUNITY_Semantic Graph Extraction|Semantic Graph Extraction]]
...
- [[_COMMUNITY_Protected Actions Branch|Protected Actions Branch]]
- [[_COMMUNITY_Thingtime GitHub Bot|Thingtime GitHub Bot]]
- [[_COMMUNITY_PR 595|PR 595]]
- [[_COMMUNITY_Vercel Deployment|Vercel Deployment]]
- [[_COMMUNITY_Credential Vault Router|Credential Vault Router]]
...
- `API Suite Job` --references--> `Versioned MongoDB Collections`  [EXTRACTED]
  .github/workflows/web-ci.yml → AGENTS.md
- `PR 634 Comment Admission Hardening` --references--> `verify Job`  [EXTRACTED]
  PRs/634-control-plane-event-hardening--harden-lopu-comment-admission.md → .github/workflows/control-plane-ci.yml
- `Control-plane Changelog` --references--> `PR 634 Comment Admission Hardening`  [EXTRACTED]
  CHANGELOG.md → PRs/634-control-plane-event-hardening--harden-lopu-comment-admission.md

## Import Cycles
- None detected.

## Hyperedges (group relationships)
- **Control-plane Validation** — github_workflows_control_plane_ci_verify, github_testing_control_plane_regression_checklist, prs_634_control_plane_event_hardening_harden_lopu_comment_admission [EXTRACTED 0.90]
...
### Community 1 - "Admin Preview Publishing"
Cohesion: 0.08
Nodes (58): ACTIVE_STATES, assertCurrentPullRequest(), assertPrebuiltOutput(), assignAlias(), boundedInteger(), cleanupDeploymentIssue(), cleanupEnvironment(), commentBody() (+50 more)

### Community 2 - "Graph Snapshot Management"
Cohesion: 0.09
...
### Community 5 - "Prebuilt Archive Extraction"
Cohesion: 0.09
...
### Community 6 - "Promotion Pick Planning"
Cohesion: 0.09
...
### Community 7 - "Conflict Resolution Routing"
Cohesion: 0.13
...
### Community 11 - "Promotion Pull Request Management"
Cohesion: 0.18
...
### Community 12 - "CodeQL PR Backfill"
Cohesion: 0.21
...
### Community 13 - "Feature Promotion Recovery"
Cohesion: 0.13
...
### Community 14 - "Agent Credential Handling"
Cohesion: 0.18
...
### Community 15 - "Main Develop Sync Merge"
Cohesion: 0.17
...
### Community 16 - "Promotion Worker Contract"
Cohesion: 0.12
...
### Community 17 - "Rebase Edit Testing"
Cohesion: 0.28
...
### Community 20 - "Promotion Workflow Routing"
Cohesion: 0.14
...
### Community 21 - "Release Pipeline Workflows"
Cohesion: 0.15
Nodes (13): Build Signed and Notarized Electron Release, Build Unsigned Electron Release, Derive SemVer PR Release Identity, Import Developer ID and Notarization Credentials, Resolve and Validate PR Source, Select Release Distribution, Thingtime Electron PR Release Workflow, Electron App Release (+5 more)

### Community 22 - "Feature Stack Progress"
Cohesion: 0.27
...
### Community 26 - "Review Queue Management"
Cohesion: 0.33
...
### Community 28 - "Credential Vault Access"
Cohesion: 0.61
...
### Community 32 - "Preview Reliability Repair"
Cohesion: 0.29
...
- **Why does `promote: replay merged develop PRs` connect `Promotion Changelog Generation` to `Feature Promotion Recovery`?**
...
- **Should `Admin Preview Publishing` be split into smaller, more focused modules?**
  _Cohesion score 0.07552447552447553 - nodes in this community are weakly interconnected._
- **Should `Graph Snapshot Management` be split into smaller, more focused modules?**
  _Cohesion score 0.0903954802259887 - nodes in this community are weakly interconnected._
- **Should `Promotion Changelog Generation` be split into smaller, more focused modules?**
  _Cohesion score 0.10631229235880399 - nodes in this community are weakly interconnected._
- **Should `Prebuilt Archive Extraction` be split into smaller, more focused modules?**
