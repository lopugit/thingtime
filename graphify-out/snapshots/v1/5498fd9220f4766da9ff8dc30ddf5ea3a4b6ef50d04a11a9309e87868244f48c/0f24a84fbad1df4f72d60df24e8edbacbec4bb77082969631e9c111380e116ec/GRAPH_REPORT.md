# Graph Report - /Users/lopu/.codex/tmp/thingtime-batch-finalizer.tyPNkJ/worktree  (2026-08-28)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 704 nodes · 1488 edges · 69 communities (36 shown, 33 thin omitted)
...
- **Lopu Repository Management Lanes** — changelog_lopu_pr_manager, changelog_conflict_resolution, changelog_promotion_replay, changelog_codeql_triage, changelog_all_branch_doctor [EXTRACTED 0.95]
- **Graphify Content-addressed Publication** — changelog_graphify_snapshot_publisher, changelog_graphify_cas_router, changelog_semantic_cache_variants, github_workflows_resolve_pr_conflicts_graphify_refresh [EXTRACTED 0.90]
- **Workflow Detector Handoff Flow** — github_workflows_resolve_pr_conflicts_lopu_pr_manager_workflow, github_workflows_resolve_pr_conflicts_push_trigger, github_workflows_resolve_pr_conflicts_pull_request_target_trigger, github_workflows_resolve_pr_conflicts_detector_handoff_input, github_workflows_resolve_pr_conflicts_pr_batch_b64_input [EXTRACTED 0.90]
...
Cohesion: 0.07
Nodes (29): Analyze Job, github/codeql-action/analyze, github/codeql-action/init, Lopu CodeQL All Branches, Select One Analysis Owner, ai-merge-paused Label, All-branch Doctor, CodeQL Triage (+21 more)
