...
## Corpus Check
- 33 files · ~166,709 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 778 nodes · 1562 edges · 106 communities (38 shown, 68 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 14 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `85c7b952`
...
### Community 18 - "Thingtime AI instructions"
Cohesion: 0.17
...
### Community 105 - "lopu-pr-status.mjs"
Cohesion: 0.17
Nodes (21): argument(), branchCode(), classifyInventory(), count(), dateParts(), escapeHtml(), FACT_LABEL_ORDER, formatZonedTimestamp() (+13 more)

## Knowledge Gaps
- **223 isolated node(s):** `BASE_BRANCHES`, `completeRefspecs`, `MERGE_CONFIG`, `CAPACITY_PATTERNS`, `CREDENTIAL_PATTERNS` (+218 more)
