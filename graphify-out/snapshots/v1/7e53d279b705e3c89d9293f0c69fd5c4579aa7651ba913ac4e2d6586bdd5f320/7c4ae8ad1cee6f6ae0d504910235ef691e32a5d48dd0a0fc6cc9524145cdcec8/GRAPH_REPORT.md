# Graph Report - main-develop-automerge-followup.EDJAfO  (2026-08-31)

## Corpus Check
- 41 files · ~180,503 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 829 nodes · 1647 edges · 112 communities (44 shown, 68 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 15 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8b72e78f`
...
### Community 111 - "PR #506 — Auto-merge resolved main to develop sync PR"
Cohesion: 0.33
