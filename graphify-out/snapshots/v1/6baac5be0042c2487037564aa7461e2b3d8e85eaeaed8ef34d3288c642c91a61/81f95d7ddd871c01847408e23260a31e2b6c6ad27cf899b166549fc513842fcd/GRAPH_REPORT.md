# Graph Report - /Users/lopu/.codex/worktrees/lopu-batch-manifest.pomhUj  (2026-08-28)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 713 nodes · 1500 edges · 72 communities (38 shown, 34 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 14 edges (avg confidence: 0.61)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f6509d81`
...
- [[_COMMUNITY_All-Branch Build Doctor|All-Branch Build Doctor]]
- [[_COMMUNITY_PR Conflict Workflows|PR Conflict Workflows]]
- [[_COMMUNITY_Promotion Stack Analysis|Promotion Stack Analysis]]
- [[_COMMUNITY_Control Plane Contract|Control Plane Contract]]
- [[_COMMUNITY_Promotion Reservation Recovery|Promotion Reservation Recovery]]
...
- [[_COMMUNITY_Main Feature Promotion|Main Feature Promotion]]
...
- [[_COMMUNITY_Rebase Edit Tests|Rebase Edit Tests]]
...
- [[_COMMUNITY_Develop Preview Control|Develop Preview Control]]
...
- [[_COMMUNITY_Rebase Engine Routing|Rebase Engine Routing]]
...
- [[_COMMUNITY_Rebase Index Fingerprint|Rebase Index Fingerprint]]
...
- [[_COMMUNITY_Principal Repository Manager|Principal Repository Manager]]
- [[_COMMUNITY_Electron Release Workflow|Electron Release Workflow]]
- [[_COMMUNITY_Lopu Agent Integration|Lopu Agent Integration]]
...
- [[_COMMUNITY_Engineering Fundamentals|Engineering Fundamentals]]
...
- [[_COMMUNITY_Global Symlink Rules|Global Symlink Rules]]
...
- [[_COMMUNITY_Lopu Agent Action|Lopu Agent Action]]
- [[_COMMUNITY_Credentialed AI Attempt|Credentialed AI Attempt]]
- [[_COMMUNITY_Conflict Set Recording|Conflict Set Recording]]
- [[_COMMUNITY_AI Credential Requirement|AI Credential Requirement]]
...
- `Thingtime AI Instructions` --semantically_similar_to--> `Thingtime AI Instructions`  [EXTRACTED] [semantically similar]
  CLAUDE.md → AGENTS.md
- `LOPU_AGENT_BACKEND` --conceptually_related_to--> `Lopu`  [INFERRED]
  .github/workflows/resolve-pr-conflicts.yml → CHANGELOG.md
- `Lopu PR Manager` --conceptually_related_to--> `CodeQL`  [INFERRED]
  .github/workflows/resolve-pr-conflicts.yml → CHANGELOG.md
- `Lopu PR Manager` --conceptually_related_to--> `Promotion`  [INFERRED]
  .github/workflows/resolve-pr-conflicts.yml → CHANGELOG.md
...
- **Lopu Repository Management Lanes** — changelog_conflict_resolution, changelog_codeql, changelog_promotion, changelog_rebase_rounds, changelog_all_branch_doctor, _github_workflows_resolve_pr_conflicts_lopu_pr_manager [EXTRACTED 0.95]
- **Graphify Content-addressed Publication** — changelog_graphify, changelog_graphify_snapshot_router, changelog_semantic_cache, _github_workflows_resolve_pr_conflicts_graphify_refresh [EXTRACTED 0.92]
- **Detector Handoff Flow** — _github_workflows_resolve_pr_conflicts_push, _github_workflows_resolve_pr_conflicts_pull_request_target, _github_workflows_resolve_pr_conflicts_workflow_dispatch, _github_workflows_resolve_pr_conflicts_claude_code_action [EXTRACTED 0.90]
...
### Community 3 - "All-Branch Build Doctor"
Cohesion: 0.16
...
### Community 4 - "PR Conflict Workflows"
Cohesion: 0.07
Nodes (35): claude-code-action, git merge-tree Verification, Post-merge Graphify Refresh, LOPU_AGENT_BACKEND, Lopu PR Manager, pull_request_target Trigger, push Trigger, resolve-pr-conflicts Workflow (+27 more)
...
### Community 6 - "Control Plane Contract"
Cohesion: 0.13
...
### Community 7 - "Promotion Reservation Recovery"
Cohesion: 0.15
...
### Community 11 - "Main Feature Promotion"
Cohesion: 0.13
...
### Community 14 - "Rebase Edit Tests"
Cohesion: 0.28
...
### Community 15 - "Rebase Round Preparation"
Cohesion: 0.26
...
### Community 16 - "Promotion Worker Script"
Cohesion: 0.35
...
Cohesion: 0.15
Nodes (12): Browser and UI Validation, Canonical Instruction File, Delivery Messaging, Thingtime AI Instructions, Thingtime AI Instructions, Data and API conventions, Fundamentals (read first), GitHub push and PR publishing (+4 more)
...
### Community 22 - "Develop Preview Control"
Cohesion: 0.20
...
### Community 27 - "Rebase Engine Routing"
Cohesion: 0.33
Nodes (6): CI Provider Router Workflow, Find Stack Members That Need Rebasing Job, Lopu Rebase Engine Workflow, REBASE_OWNER_JQ, Route Job, STACK_MEMBER_JQ

### Community 28 - "Vercel Deployment Config"
Cohesion: 0.33
Nodes (5): framework, git, deploymentEnabled, ignoreCommand, $schema

### Community 29 - "CodeQL Branch Analysis"
Cohesion: 0.40
...
### Community 30 - "Electron PR Release"
Cohesion: 0.50
Nodes (4): assertPrReleaseContract(), count(), here, workflow

### Community 31 - "Rebase Index Fingerprint"
Cohesion: 0.80
Nodes (4): rawIndexHash(), runGit(), semanticIndexHash(), sha256()

### Community 32 - "Control Plane Changelog"
Cohesion: 0.50
Nodes (4): Control-plane Changelog, github-actions Branch, Keep a Changelog, Product Branch Thin Listeners

### Community 33 - "Rebase Ownership Routing"
Cohesion: 0.83
Nodes (3): assert_owner(), assert_stack(), rebase-ownership-routing-contract.sh script

### Community 36 - "Principal Repository Manager"
Cohesion: 0.50
...
- **Why does `promote: replay merged develop PRs` connect `Promotion PR Changelog` to `Main Feature Promotion`?**
...
- **Should `PR Conflict Workflows` be split into smaller, more focused modules?**
