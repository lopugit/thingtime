...
- `Graphify Rules` --semantically_similar_to--> `Graphify Rules`  [EXTRACTED] [semantically similar]
  CLAUDE.md → AGENTS.md
- `Lopu CodeQL All Branches` --conceptually_related_to--> `CodeQL triage and backfill`  [INFERRED]
...
- **Graphify snapshot publication and validation flow** — changelog_graphify_cas, _github_actions_rebase_conflict_round_action_graphify_cas_mjs, _github_actions_rebase_conflict_round_action_stage_graphify_snapshots_mjs, _github_workflows_control_plane_ci_control_plane_ci_workflow [EXTRACTED 0.86]
- **Lopu repository automation fleet** — _github_workflows_resolve_pr_conflicts_pr_manager_workflow, _github_workflows_rebase_pr_stacks_rebase_engine_workflow, _github_workflows_all_branch_all_branch_workflow, _github_actions_lopu_agent_action_lopu_agent_action [EXTRACTED 0.90]
...
## Communities (74 total, 38 thin omitted)
...
Cohesion: 0.07
Nodes (34): classify-claude-credential-failure.mjs, anthropics/claude-code-action, openai/codex-action, Lopu agent composite action, lopu-credential-vault.mjs, graphify-cas.mjs, prepare-round.sh, Lopu rebase conflict round composite action (+26 more)
...
### Community 36 - "codeql-analysis.yml"
Cohesion: 1.00
Nodes (3): Lopu internal develop promotion, Lopu internal feature promotion, Sync main into develop

## Knowledge Gaps
- **181 isolated node(s):** `BASE_BRANCHES`, `completeRefspecs`, `MERGE_CONFIG`, `CAPACITY_PATTERNS`, `CREDENTIAL_PATTERNS` (+176 more)
...
- **Should `Analyze Job` be split into smaller, more focused modules?**
