# Graph Report - /Users/lopu/.codex/worktrees/recovery-release-builder  (2026-09-05)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 829 nodes · 1709 edges · 90 communities (42 shown, 48 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 17 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ae9a113a`
...
- `CI Control Plane README` --references--> `Lopu Rebase Conflict Round Action`  [INFERRED]
  README.md → .github/actions/rebase-conflict-round/action.yml
...
- `Thingtime Credential Vault Router` --conceptually_related_to--> `Lopu Agent Action`  [INFERRED]
  PRs/609-codex-preview-manager-reliability.md → .github/actions/lopu-agent/action.yml
...
- `Lopu Rebase Conflict Round Action` --calls--> `Prepare Rebase Round Script`  [EXTRACTED]
...
- **Shared Desktop Release Pipeline** — github_workflows_electron_release_workflow, github_workflows_electron_pr_release_workflow, readme_document [EXTRACTED 0.90]
...
## Communities (90 total, 48 thin omitted)
...
Cohesion: 0.09
Nodes (23): Control-plane Changelog, Lopu Agent Action, Lopu Rebase Conflict Round Action, CAPACITY_PATTERNS, classifyClaudeCredentialFailure(), collectStrings(), CREDENTIAL_PATTERNS, main() (+15 more)
...
Cohesion: 0.08
Nodes (22): Thingtime AI Instructions, Browser and UI validation, Canonical instruction file, Data and API conventions, Delivery messaging, Fundamentals (read first), GitHub push and PR publishing, graphify (+14 more)
...
### Community 21 - "Lopu Agent Action"
Cohesion: 0.27
...
### Community 37 - "electron-pr-release-contract.mjs"
Cohesion: 0.83
Nodes (3): assert_owner(), assert_stack(), rebase-ownership-routing-contract.sh script

### Community 40 - "`github-actions` — the CI control plane"
Cohesion: 0.67
Nodes (3): Lopu internal all-branch integration workflow, build-all-branch.mjs, Lopu Agent Action

### Community 41 - "rebase-ownership-routing-contract.sh"
Cohesion: 0.67
Nodes (3): build_and_run.sh, Commander App Release workflow, release-version.mjs

### Community 42 - "resolve-canonical-instruction-type-conflicts.sh"
Cohesion: 0.67
Nodes (3): GitHub CodeQL Action, CodeQL Analyze Job, CodeQL Scope Job

## Knowledge Gaps
- **215 isolated node(s):** `BASE_BRANCHES`, `completeRefspecs`, `MERGE_CONFIG`, `REQUIRED_CATEGORIES`, `ACTIVE_RUN_STATUSES` (+210 more)
...
- **Why does `Preview Publisher Controller Job` connect `build-all-branch.mjs` to `deploy-develop-pr-preview.mjs`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `Admin Preview Publisher Job` connect `deploy-admin-pr-previews.mjs` to `build-all-branch.mjs`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `promote: replay merged develop PRs` connect `graphify-cas.mjs` to `merge-main-develop-sync-pr.mjs`?**
