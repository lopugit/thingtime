# Graph Report - /Users/lopu/.codex/worktrees/lopu-review-dedupe.mqQ5Lc  (2026-08-28)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 714 nodes · 1497 edges · 72 communities (38 shown, 34 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 14 edges (avg confidence: 0.6)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `849b039b`
...
- `Post-merge Graphify refresh` --semantically_similar_to--> `Graphify snapshots`  [INFERRED] [semantically similar]
  .github/workflows/resolve-pr-conflicts.yml → CHANGELOG.md
...
- **Lopu Control Plane Flow** — changelog_github_actions_branch, changelog_product_branch_listeners, changelog_lopu_pr_manager, _github_workflows_resolve_pr_conflicts_workflow [EXTRACTED 0.88]
- **Model-backed Repository Lanes** — changelog_conflict_resolution, changelog_codeql_triage, changelog_promotion_lanes, changelog_all_branch_doctor, changelog_lopu_pr_manager [EXTRACTED 0.90]
- **Workflow Dispatch Routing Inputs** — _github_workflows_resolve_pr_conflicts_detector_handoff, _github_workflows_resolve_pr_conflicts_pr_batch_b64, _github_workflows_resolve_pr_conflicts_control_dispatch_id, _github_workflows_resolve_pr_conflicts_maintenance_operation [EXTRACTED 0.87]
...
Cohesion: 0.09
Nodes (24): Analyze Job, github/codeql-action/analyze, github/codeql-action/init, Lopu CodeQL All Branches, Select One Analysis Owner, execution provider routing inputs, Post-merge Graphify refresh, Lopu PR manager workflow (+16 more)
...
Cohesion: 0.25
Nodes (8): control_dispatch_id input, detector_handoff input, maintenance_operation input, pr_batch_b64 input, Dynamic run-name routing, Control-plane changelog, github-actions branch, Product branch thin listeners
...
### Community 39 - "Lopu Agent Action"
Cohesion: 1.00
Nodes (3): Lopu internal develop promotion, Lopu internal feature promotion, Sync main into develop

## Knowledge Gaps
- **188 isolated node(s):** `CAPACITY_PATTERNS`, `CREDENTIAL_PATTERNS`, `REQUIRED_CATEGORIES`, `ACTIVE_RUN_STATUSES`, `TRUSTED_ASSOCIATIONS` (+183 more)
