...
## Corpus Check
- 31 files · ~164,249 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 753 nodes · 1512 edges · 105 communities (37 shown, 68 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 13 edges (avg confidence: 0.58)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d466aa86`
...
## Communities (105 total, 68 thin omitted)
...
## Knowledge Gaps
- **221 isolated node(s):** `BASE_BRANCHES`, `completeRefspecs`, `MERGE_CONFIG`, `CAPACITY_PATTERNS`, `CREDENTIAL_PATTERNS` (+216 more)
