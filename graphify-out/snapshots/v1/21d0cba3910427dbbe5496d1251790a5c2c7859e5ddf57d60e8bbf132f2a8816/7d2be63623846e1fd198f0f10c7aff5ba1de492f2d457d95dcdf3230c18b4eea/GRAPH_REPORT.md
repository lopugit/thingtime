...
## Corpus Check
- 33 files · ~158,429 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 726 nodes · 1471 edges · 103 communities (37 shown, 66 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.54)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7976426b`
...
Cohesion: 0.16
Nodes (35): assertAllBranchWorkflowContract(), BASE_BRANCHES, buildMode(), checkMode(), completeRefspecs, countLeadingFailureMarkers(), doctorCommitMode(), doctorRecordMode() (+27 more)
