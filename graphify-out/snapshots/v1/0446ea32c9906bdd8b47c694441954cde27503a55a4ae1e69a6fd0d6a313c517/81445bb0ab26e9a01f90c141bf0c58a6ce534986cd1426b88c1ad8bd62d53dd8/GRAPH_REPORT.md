# Graph Report - /Users/lopu/.codex/worktrees/lopu-graphify-update-exclude.u7IRr1  (2026-08-28)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 736 nodes · 1530 edges · 73 communities (38 shown, 35 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 14 edges (avg confidence: 0.59)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fa5ba735`
...
Cohesion: 0.08
Nodes (29): Analyze Job, github/codeql-action/analyze, github/codeql-action/init, Lopu CodeQL All Branches, Select One Analysis Owner, AI_ALL.md Symlink Canonicalization, ai-merge-paused Label, All Branch Doctor (+21 more)
...
Cohesion: 0.40
Nodes (5): Control Plane Changelog, Signed Desktop PR Releases, github-actions Branch, Keep a Changelog, Product Branches
...
## Knowledge Gaps
- **194 isolated node(s):** `CAPACITY_PATTERNS`, `CREDENTIAL_PATTERNS`, `REQUIRED_CATEGORIES`, `ACTIVE_RUN_STATUSES`, `TRUSTED_ASSOCIATIONS` (+189 more)
...
- **Why does `promote: replay merged develop PRs` connect `promotion-pr-changelog.mjs` to `codeql-open-pr-backfill.mjs`?**
