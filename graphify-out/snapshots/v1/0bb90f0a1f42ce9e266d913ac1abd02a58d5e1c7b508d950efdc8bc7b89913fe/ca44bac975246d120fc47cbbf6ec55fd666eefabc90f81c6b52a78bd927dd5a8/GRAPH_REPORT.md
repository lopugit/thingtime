# Graph Report - worktree  (2026-08-29)

## Corpus Check
- 33 files · ~168,382 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 780 nodes · 1564 edges · 106 communities (38 shown, 68 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 14 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fe907bd9`
...
## Communities (106 total, 68 thin omitted)
...
Cohesion: 0.17
Nodes (21): argument(), branchCode(), classifyInventory(), count(), dateParts(), escapeHtml(), FACT_LABEL_ORDER, formatZonedTimestamp() (+13 more)
...
### Community 105 - "Thingtime AI instructions"
Cohesion: 0.17
...
## Knowledge Gaps
- **225 isolated node(s):** `BASE_BRANCHES`, `completeRefspecs`, `MERGE_CONFIG`, `CAPACITY_PATTERNS`, `CREDENTIAL_PATTERNS` (+220 more)
