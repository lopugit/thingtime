...
## Corpus Check
- 41 files · ~179,927 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 803 nodes · 1618 edges · 106 communities (42 shown, 64 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 15 edges (avg confidence: 0.58)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `20d80733`
...
- `Lopu internal main/develop synchronization` --conceptually_related_to--> `main into develop sync lane`  [INFERRED]
...
- `post-merge Graphify refresh` --conceptually_related_to--> `Graphify immutable content-addressed snapshots`  [INFERRED]
  .github/workflows/resolve-pr-conflicts.yml → README.md
- `verify job` --references--> `workflow-control-plane-contract.mjs`  [EXTRACTED]
...
- **Graphify Content-addressed Publication** — changelog_graphify_cas_router, changelog_graphify_semantic_refresh, readme_graphify_immutable_snapshots, _github_workflows_resolve_pr_conflicts_graphify_refresh [EXTRACTED 0.85]
- **Lopu Repository Maintenance Control Plane** — changelog_lopu_pr_manager, readme_lopu_principal_repository_manager, _github_workflows_resolve_pr_conflicts_workflow, _github_workflows_sync_main_into_develop_workflow [EXTRACTED 0.90]
...
Cohesion: 0.18
Nodes (13): comment-contract-advisories job, contract-advisories job, verify job, Workflow control-plane CI, ci-provider-router.yml, merge-main-develop-sync-pr.mjs, route job, sync job (+5 more)
...
### Community 34 - "resolve-canonical-instruction-type-conflicts.sh"
Cohesion: 0.50
Nodes (4): assertPrReleaseContract(), count(), here, workflow

### Community 35 - "resolve-canonical-instruction-type-conflicts.test.mjs"
Cohesion: 0.80
...
### Community 71 - "Post-merge Graphify Refresh"
Cohesion: 0.12
...
### Community 72 - "Develop PR Preview Deployment Script"
Cohesion: 0.33
...
### Community 74 - "Browser and UI Validation"
Cohesion: 0.50
Nodes (4): post-merge Graphify refresh, .github/actions/lopu-agent, Lopu PR manager workflow, Graphify immutable content-addressed snapshots
