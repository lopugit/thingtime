# Graph Report - /private/tmp/thingtime-executable-rebase.BBOIW0/worktree  (2026-08-28)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 712 nodes · 1494 edges · 73 communities (39 shown, 34 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 10 edges (avg confidence: 0.52)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cc4fc490`
...
- `Graphify Rules` --semantically_similar_to--> `Graphify Rules`  [EXTRACTED] [semantically similar]
  CLAUDE.md → AGENTS.md
- `Resolve this rebase conflict set with Lopu in scratch` --references--> `Rebase Rounds`  [EXTRACTED]
...
- **Lopu Repository Management Flows** — changelog_lopu, changelog_conflict_resolution, changelog_rebase_rounds, changelog_codeql, changelog_promotion, changelog_all_branch_doctor [EXTRACTED 0.90]
- **Graphify Snapshot Publication Flow** — changelog_graphify, changelog_graphify_out, changelog_trusted_controller, changelog_lopu [EXTRACTED 0.85]
...
Cohesion: 0.07
Nodes (31): AI_ALL Root Instruction Symlinks, all-branch Doctor, CodeQL, Conflict Resolution, Lopu, Lopu PR Manager, Promotion, Rebase Rounds (+23 more)
...
Cohesion: 0.67
Nodes (3): Graphify, graphify-out, Trusted Controller

### Community 40 - "Browser and UI Validation"
Cohesion: 1.00
Nodes (3): Lopu internal develop promotion, Lopu internal feature promotion, Sync main into develop

## Knowledge Gaps
- **190 isolated node(s):** `CAPACITY_PATTERNS`, `CREDENTIAL_PATTERNS`, `REQUIRED_CATEGORIES`, `ACTIVE_RUN_STATUSES`, `TRUSTED_ASSOCIATIONS` (+185 more)
