...
- **Protected** kinds — `user`, `theme`, `feed-algorithm`, `waitlist`, `app`,
  ...
  `account-link`, `migration-diagnostic`, `attachment`, `ai-model`, every
