...
- **Protected** kinds — `user`, `theme`, `feed-algorithm`, `waitlist`, `app`,
  ...
  reserved in `sanitizeShareId`) is system-owned `storageClass: "control"`.
