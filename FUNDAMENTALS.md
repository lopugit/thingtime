...
- **Protected** kinds — `user`, `theme`, `feed-algorithm`, `waitlist`, `app`,
  ...
  `lopu-account`, `lopu-usage`, `lopu-credit`, and every
  `ci-*` control-plane kind — are
